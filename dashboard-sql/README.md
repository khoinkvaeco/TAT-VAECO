...
Bật server ở chế độ **live** nhưng trỏ vào một địa chỉ DB không tồn tại, rồi gọi lần lượt **18 endpoint** có chạy truy vấn. Mỗi endpoint sẽ chạy **hết** phần dựng câu SQL rồi mới chết ở bước kết nối:
